...
//                             </td> */}
//                             <td className="border border-gray-300 p-3 flex flex-col md:flex-row justify-center items-center gap-2">
//                                 <button
//                                     className="bg-yellow-500 text-white px-3 py-2 rounded-md w-full md:w-auto text-sm md:text-base hover:bg-yellow-600 transition"
...
//                                 <button
//                                     className="bg-red-500 text-white px-3 py-2 rounded-md w-full md:w-auto text-sm md:text-base hover:bg-red-600 transition"
